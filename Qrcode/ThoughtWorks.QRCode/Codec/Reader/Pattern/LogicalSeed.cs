...
// Type: ThoughtWorks.QRCode.Codec.Reader.Pattern.LogicalSeed
...
namespace ThoughtWorks.QRCode.Codec.Reader.Pattern
{
  public class LogicalSeed
  {
    ...
    static LogicalSeed()
    {
      LogicalSeed.seed[0] = new int[2]
      {
        6,
        14
      };
      LogicalSeed.seed[1] = new int[2]
      {
        6,
        18
      };
      LogicalSeed.seed[2] = new int[2]
      {
        6,
        22
      };
      LogicalSeed.seed[3] = new int[2]
      {
        6,
        26
      };
      LogicalSeed.seed[4] = new int[2]
      {
        6,
        30
      };
      LogicalSeed.seed[5] = new int[2]
      {
        6,
        34
      };
